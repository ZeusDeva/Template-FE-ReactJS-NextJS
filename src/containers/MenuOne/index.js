  ...
  return (
    <Layout>
      ...
      <Content style={{ padding: "20px 50px", minHeight: "80vh" }}>
        ...
        >
          <Title level={4}>Daftar Informasi Menu 1</Title>
        </div>
        <Row gutter={[16, 16]}>
          {data.map((item, index) => (
...
export default InformasiPageMenuOne;
